...
for(const [token,value] of Object.entries({__CW_ENGINE__:read('engine.js'),__CW_FEEDBACK__:read('feedback.js'),__CW_ECOLOGY__:read('ecology.js'),__CW_TERRAIN__:read('terrain.js'),__CW_DATA__:json('input.json')})){
...
const out=process.argv[2]||'/workspace/crossweave-terrain-hunt.html';
