...
async function makeFixture(){
 ...
 return {version:'two-stage-ui-5.2',source_design:'7565afca98684186705a4e865d4fdf0e0ae489c1',
...
async function build({write=false,testing=false,output='/workspace/crossweave-acquisition-hold.html'}={}){
