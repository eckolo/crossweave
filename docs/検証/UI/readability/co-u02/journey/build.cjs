...
function build({testing=false,fixture='return',start='journey'}={}){
 ...
 const script=[runtime.code,read('../session.js'),read('../window-placement.js'),read('../prose-layout.js'),read('../card-properties.js'),read('../action-forecast.js'),read('../hold-cue.js'),require('../art-assets/build.cjs').build(),read('../exploration.js'),buildView(),
