...
版0.10.1／2026-09-17。UI-PLAN-001、継続Work `20260910-ui-readability`、枝 `ui/readability-20260910`。

最新変更：[再開後の成功通知を削除](save-flow.md#resume-notice-fix)。中断→続きからで元の場面へ戻り、追加の通知を閉じる操作を不要にした。
