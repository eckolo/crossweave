...
function build({testing=false,standalone=false}={}){
 ...
 return standalone?'<!doctype html><html lang="ja"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>crossweave — 準備と成長</title><style>body{margin:0;padding:12px;max-width:1440px;margin-inline:auto;font-family:system-ui,sans-serif;color-scheme:light dark}</style></head><body>'+html+'</body></html>':html;
}
